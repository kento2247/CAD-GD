...
parser.add_argument(
    "--stats_dir",
    default="./exp/fsc147_debug/fsc_147_debug",
    type=str,
...
parser.add_argument(
    "--threshold", default=0.35, type=float, help="threshold for localization"
)

## data aug
parser.add_argument("--horizon_flip", action="store_true", help="if horizon flip")
parser.add_argument(
    "--horizon_flip_prob", default=0.5, type=float, help="probality for horizon flip"
)
parser.add_argument("--vertical_flip", action="store_false", help="if vertical flip")
parser.add_argument(
    "--vertical_flip_prob", default=0.5, type=float, help="probality for vertical flip"
)
...
test_mae, test_rmse, test_TP, test_FP, test_FN, test_precision, test_recall, test_f1 = (
    eval_reproduce(args.load_mode, model, loaders, args)
)
