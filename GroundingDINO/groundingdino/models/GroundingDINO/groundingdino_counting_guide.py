...
from .transformer_counting_guide import build_transformer
from .utils import MLP, ContrastiveEmbed

# context density aware grounding dino
# model design:
"""
image-> swin-tf-t -> vison_feature   -> categorical counting module -> queries selection
...
def build_groundingdinocountingguide(args):
    ...
    model = GroundingDINOCountingGuide(
        backbone,
        transformer,
