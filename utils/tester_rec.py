...
def eval(split, model, loaders, annotations, args):
    ...
    for images, captions, shapes, img_caps, density_maps in tqdm(loader): # tensor, list, list, list
        ...
        results = threshold_dynamic_context(outputs,captions,model.tokenizer, pred_num_round)
