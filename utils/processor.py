...
class DataProcessor:
    ...
    def get_prompt_for_image(self, image_id_caption: tuple):
        assert (
            type(image_id_caption) == tuple and len(image_id_caption) == 2
        ), "input must be a tuple of (image_id, caption)"
