...
parser.add_argument(
    "--stats_dir",
    default="./exp/fsc147_debug/fsc_147_debug_1",
    type=str,
...
parser.add_argument(
    "--threshold", default=0.3, type=float, help="threshold for localization"
)
...
for epoch in range(0, args.epochs):
    ...
    ) = train(model, loaders, optimizer, scheduler, args)
    (
        val_mae,
        val_rmse,
        val_TP,
        ...
        val_mae_regression,
        val_rmse_regression,
    ) = eval_fn("val", model, loaders, args)
